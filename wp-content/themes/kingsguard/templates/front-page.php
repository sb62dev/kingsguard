...
<section class="homeVideoSlider homeBannerWrap">
        ...
        <div class="homeDesktopSlider slider mb-0 homeBannerSlider">
            <?php while (have_rows('banner_sliderr')) : the_row(); ?>
                <?php
                    $banner_slider_image = get_sub_field('banner_slider_image');
                    if (isset($banner_slider_image) && !empty($banner_slider_image)) {
                        $image_url = wp_get_attachment_image_src($banner_slider_image, 'full')[0];
                        $image_alt = get_post_meta($banner_slider_image, '_wp_attachment_image_alt', true);
                ?>
                <div class="heroSlide homeBannerSlide">
                    <div class="homeBannerSlideInner">
                        <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>">
                        <?php 
                            $banner_slider_content = get_sub_field('banner_slider_content');
                            if(isset($banner_slider_content) && !empty($banner_slider_content)){
                        ?> 
                        <div class="homeBannerContWrap">
                            <div class="sm_container">
                                <div class="homeBannerCont">
                                    <h1 class="h2 animated-text" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300"><?php echo $banner_slider_content; ?></h1>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
        ...
        <?php if (have_rows('banner_sliderr')) : ?>
        <div class="homeMobileSlider slider mb-0 homeBannerSlider">
            <?php while (have_rows('banner_sliderr')) : the_row(); ?>
                <?php
                    $mob_banner_slider_image = get_sub_field('mob_banner_slider_image');
                    if (isset($mob_banner_slider_image) && !empty($mob_banner_slider_image)) {
                        $image_url = wp_get_attachment_image_src($mob_banner_slider_image, 'full')[0];
                        $image_alt = get_post_meta($mob_banner_slider_image, '_wp_attachment_image_alt', true);
                ?>

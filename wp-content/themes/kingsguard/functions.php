	...
	function twenty_twenty_one_setup() {
		...
		register_nav_menus(
			array(
				...
				'mobile-menu'  => esc_html__( 'Mobile menu', 'twentytwentyone' ),
...
// Custom Newsleter Form Admin
require_once get_template_directory() . '/admin/jobseekers/newsletter/admin/newsletter-admin-page.php';
...
require get_template_directory() . '/custom/custom-post-type.php';  
...
function filter_projects_ajax_handler() {
    ...
    if ($projects_query->have_posts()) {
        ...
        while ($projects_query->have_posts()) : $projects_query->the_post();
            ...
            ?>
            <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-down" data-aos-duration="1000" data-city="<?php echo esc_attr($project_city_names_str); ?>" data-service="<?php echo esc_attr($project_service_names_str); ?>">
        ...
        wp_send_json_error('<div class="col-sm-12"><div class="noProjectFound">No projects found</div></div>');
    }
}

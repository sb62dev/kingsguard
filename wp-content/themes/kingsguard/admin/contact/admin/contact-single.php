...
function view_quote_page() {
    ...
    if (isset($user->contact_fname) && !empty($user->contact_fname)) {
        ...
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-id-card" aria-hidden="true"></i></div>';
        echo '<h6>Name:</h6>';
    ...
    if (isset($user->email) && !empty($user->email)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-envelope" aria-hidden="true"></i></div>';
        echo '<h6>Email:</h6>';
    ...
    if (isset($user->contact_title) && !empty($user->contact_title)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-file-text" aria-hidden="true"></i></div>';
        echo '<h6>Title:</h6>';
    ...
    if (isset($user->phone_number) && !empty($user->phone_number)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-phone" aria-hidden="true"></i></div>';
        echo '<h6>Phone:</h6>';
    ...
    if (isset($user->contact_services) && !empty($user->contact_services)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-pie-chart" aria-hidden="true"></i></div>';
        echo '<h6>Services:</h6>';
    ...
    if (isset($user->contact_security_services) && !empty($user->contact_security_services)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-shield" aria-hidden="true"></i></div>';
    ...
    if (isset($user->contact_parking_services) && !empty($user->contact_parking_services)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-car" aria-hidden="true"></i></div>';
    ...
    if (isset($user->contact_site_types) && !empty($user->contact_site_types)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-map-signs" aria-hidden="true"></i></div>';
    ...
    if (isset($user->contact_length_cover) && !empty($user->contact_length_cover)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-calendar" aria-hidden="true"></i></div>';
    ...
    if (isset($user->contact_add_info) && !empty($user->contact_add_info)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-question-circle" aria-hidden="true"></i></div>';
    ...
    if (isset($user->submission_date) && !empty($user->submission_date)) {
        echo '<div class="col-xl-4 col-md-6 col-sm-4">';
        echo '<div class="applicantInfo"><div class="applicantIcon"><i class="fa fa-clock-o" aria-hidden="true"></i></div>';

 ...
 *
 * Override this template by copying it to yourtheme/simple_job_board/v1/global/content-wrapper-start.php
 * 
 * @author 	PressTigers
...
if (get_option('job_board_container_class') !== false) {
...
// Get Container Id
if (get_option('job_board_container_id') !== false) {

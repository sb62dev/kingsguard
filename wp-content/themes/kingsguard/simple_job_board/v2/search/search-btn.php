 ...
 *
 * Override this template by copying it to yourtheme/simple_job_board/v2/search/search-btn.php
 *
 * @author 	PressTigers
...
{
    // Search Button 
    $search_button = '<div class="sjb-search-button ' . apply_filters('sjb_filters_button_class', 'col-md-2 col-xs-12') . '">'
